---
title: "Introduction to Sub-Processes in R: Linux"
author: "Lukasz A. Bartnik"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to Sub-Processes in R: Linux}
...
let's load the `subprocess` package and define a few helper functions
...
R_binary <- function () {
  R_exe <- ifelse (is_window(), "R.exe", "R")
  return(file.path(R.home("bin"), R_exe))
}
```


Now we can correctly identify the path to the executable and spawn the
child process:
